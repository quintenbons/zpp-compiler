...
public:
  ...
  void decorate(scopes::ScopeStack &scopeStack, scopes::Scope &scope);
  void debug(size_t depth) const;
...
public:
  ...
  std::string genAsm_x86_64(codegen::NasmGenerator_x86_64 &evaluator) const;
